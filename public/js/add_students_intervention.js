...
let addStudentInterventionForm = document.getElementById("add-students-intervention-ajax");

// Modify the objects we need
addStudentInterventionForm.addEventListener("submit", function (e) {
    ...
    xhttp.open("POST", "/add-students-intervention-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("studentsIntervention-table");
    ...
    row.appendChild(idIntervention);
