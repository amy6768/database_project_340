...
let addTestScoreForm = document.getElementById("add-students-teacher-ajax");
...
addTestScoreForm.addEventListener("submit", function (e) {
    ...
    let inputIdTeacher = document.getElementById("add-idTeacher");
    ...
    xhttp.open("POST", "/add-students-teacher-ajax", true);
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("studentsTeacher-table");
    ...
    idCell.innerText = newRow.idStudentsTeacher;
